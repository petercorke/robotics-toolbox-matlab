...
CGen.logmsg([datestr(now),'\tGenerating m-function for the robot Coriolis matrix row  ' ]);
...
hStruct.inputs = {['q:  ',int2str(rob.n),'-element vector of generalized'],...
                   ...
                   '     velocities. Velocities have to be given in radians/sec!'};
...
hStruct.shortDescription = ['Configuration dependent Coriolis matrix for the ',rob.name,' arm.'];
...
hStruct.authors = {'This is an autogenerated function!',...
    ...
    '2012 RST, Technische Universität Dortmund, Germany',...
    'http://www.rst.e-technik.tu-dortmund.de'};
hStruct.seeAlso = {'SerialLink\coriolis'};
end