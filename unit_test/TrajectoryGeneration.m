...
function Test_ctraj
    ...
    expected_out(:,:,3) = [1     0     0     2
                           ...
                           0     0     1     2
                           0     0     0     1];
    assertElementsAlmostEqual(ctraj(transl([1 1 1]),transl([2 2 2]),3),...
    ...
    expected_out(:,:,3) = [1.0000         0         0    1.9000
                                ...
                                0         0    1.0000    1.9000
                                0         0         0    1.0000];
    assertElementsAlmostEqual(ctraj(transl([1 1 1]),transl([2 2 2]),[0.1 0.5 0.9]),...
            expected_out,'absolute',1e-4);
...
function Test_jtraj
    ...
    assertElementsAlmostEqual(Q,...
            [0.1000    0.2000    0.3000    0.4000    0.5000
             ...
             0.5000    0.4000    0.3000    0.2000    0.1000],'absolute',1e-4);
    ...
    assertElementsAlmostEqual(Qd,...
            [0.8424    0.4560    0.0696   -0.3168   -0.7032
             ...
             0.1000    0.2000    0.3000    0.4000    0.5000],'absolute',1e-4);
    assertElementsAlmostEqual(Qdd,...
...
% unit testing lspb 
    ...
    assertElementsAlmostEqual(Qd,...
            [     0         0         0         0         0
             ...
             0.1125    0.0562         0   -0.0562   -0.1125
                  0         0         0         0         0],'absolute',1e-4);
    assertElementsAlmostEqual(Qdd,...
            [0.1125    0.0563         0   -0.0563   -0.1125
             0.1125    0.0563         0   -0.0563   -0.1125
                  0         0         0         0         0
            -0.1125   -0.0563         0    0.0563    0.1125
            -0.1125   -0.0563         0    0.0563    0.1125],'absolute',1e-4);
    %Testing lspb with T 
    ...
    assertElementsAlmostEqual(Qdd,...
            [0.2000    0.1000         0   -0.1000   -0.2000
             0.2000    0.1000         0   -0.1000   -0.2000
            -0.2000   -0.1000         0    0.1000    0.2000
            -0.2000   -0.1000         0    0.1000    0.2000],'absolute',1e-4);
...
function Test_trinterp
    ...
    expected_out(:,:,3)= [1.0000         0         0    0.4000
                               ...
                               0         0    1.0000         0
                               0         0         0    1.0000];
    assertElementsAlmostEqual(trinterp(T1,T2,S),...
            expected_out, 'absolute',1e-4);
    ...
    expected_out(:,:,3)= [1.0000         0         0    0.4000
                               ...
                               0         0   -1.0000         0
                               0         0         0    1.0000];
    assertElementsAlmostEqual(trinterp(T1,S),...
            expected_out, 'absolute',1e-4);
