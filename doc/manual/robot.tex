...
This version corresponds to the \textbf{second edition} of the book ``\textit{Robotics, Vision \& Control, second edition}'' published in June 2017 -- RVC2.
...
\item The class \texttt{Lattice} is a kino-dynamic lattice path planner.
...
The Toolbox has been tested under R2016b and R2017bPRE.  Compatibility problems are increasingly likely the older your version of \Mlab\ is.
